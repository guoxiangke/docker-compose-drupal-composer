<?php
namespace Drupal\wechat_api\Plugin\Wechat;
...
class Wechat
{
  ...
  //dale change begin!!!
  public $uid;//which mp account! uid!
  public $wx_uid;//which wx account! uid!

  public function getWxUid(){
    return $this->wx_uid;
  }
  public function setWxUid($uid){
    $this->wx_uid=$uid;
  }
  public function __construct($options)
  {
    $this->uid = isset($options['account'])?$options['account']:'';
  //dale change end!!!
